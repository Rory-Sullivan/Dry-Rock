"""
Code for handling the gathering of our weather data and creation of reports to be emailed.
"""
...
class WeatherData:
    ...
    def update_html_report(self):
        ...
        for place in self.places:
            ...
            # ----------------------------------------------------------------------------------------------------------
            relevant_forecast = self.yr_data_for_places[place.name].long_range_forecast
            ...
            for intervals in [tom_intervals_for_place, sat_intervals_for_place, sun_intervals_for_place]:
                total_rain = 0.0
        ...
        env = Environment(
            loader=FileSystemLoader("templates"),  # Loads templates from our templates directory.
...
if __name__ == "__main__":
    ...
    test_weather_data = WeatherData(dt.datetime.now(), [Place("Dublin", "Ireland/Leinster/Dublin",
